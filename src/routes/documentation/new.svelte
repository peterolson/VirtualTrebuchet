<h1>New in VirtualTrebuchet 2.0</h1>
...
<blockquote>
	...
	<p>
		• VirtualTrebuchet 2.0 has a new <a href="/user-projects">User Projects</a> page where users can
	...
	<p>• Wind Speed has been added as an input in the <a href="/">Simulator</a>.</p>
</blockquote>
